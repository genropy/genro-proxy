...
operations for the current running Genro proxy via REST API and CLI commands.
...
For process-level operations (start, stop, restart instances), see
ProxyEndpoint in genro_proxy.proxy_endpoint.
...
Example:
    CLI commands auto-generated::
        ...
        gproxy instance run-now --tenant-id my_tenant
