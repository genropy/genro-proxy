...
Example:
    CLI commands auto-generated::
        ...
        gproxy command_log list --tenant-id acme --limit 50
        gproxy command_log get --command-id 123
        gproxy command_log export --tenant-id acme
        gproxy command_log purge --threshold-ts 1700000000
